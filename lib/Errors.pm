...
@EXPORT_OK = (
paramErr noHardwareErr notEnoughHardwareErr userCanceledErr qErr
vTypErr corErr unimpErr SlpTypeErr seNoDB
controlErr statusErr readErr writErr badUnitErr
unitEmptyErr openErr closErr dRemovErr abortErr
iIOAbortErr notOpenErr unitTblFullErr dceExtErr slotNumErr
gcrOnMFMErr dirFulErr dskFulErr nsvErr ioErr
bdNamErr fnOpnErr eofErr posErr mFulErr
tmfoErr fnfErr wPrErr vLckdErr fBsyErr
dupFNErr opWrErr rfNumErr gfpErr volOffLinErr
permErr volOnLinErr nsDrvErr noMacDskErr extFSErr
fsRnErr badMDBErr wrPermErr dirNFErr tmwdoErr
badMovErr wrgVolTypErr fidNotFound fidExists notAFileErr
diffVolErr catChangedErr desktopDamagedErr sameFileErr badFidErr
notARemountErr fileBoundsErr fsDataTooBigErr volVMBusyErr badFCBErr
errFSUnknownCall errFSBadFSRef errFSBadForkName errFSBadBuffer errFSBadForkRef
errFSBadInfoBitmap errFSMissingCatInfo errFSNotAFolder errFSForkNotFound errFSNameTooLong
errFSMissingName errFSBadPosMode errFSBadAllocFlags errFSNoMoreItems errFSBadItemCount
errFSBadSearchParams errFSRefsDifferent errFSForkExists errFSBadIteratorFlags errFSIteratorNotFound
errFSIteratorNotSupported envNotPresent envBadVers envVersTooBig fontDecError
fontNotDeclared fontSubErr fontNotOutlineErr firstDskErr lastDskErr
noDriveErr offLinErr noAdrMkErr dataVerErr badCksmErr
badBtSlpErr noDtaMkErr badDCksum badDBtSlp wrUnderrun
cantStepErr tk0BadErr initIWMErr twoSideErr spdAdjErr
seekErr sectNFErr fmt1Err fmt2Err verErr
clkRdErr clkWrErr prWrErr prInitErr rcvrErr
noScrapErr eLenErr ddpSktErr ddpLenErr noBridgeErr
lapProtErr excessCollsns portNotPwr portInUse memROZWarn
memROZError memROZErr memFullErr nilHandleErr memWZErr
memPurErr memAdrErr memAZErr memPCErr memBCErr
memSCErr iMemFullErr resourceInMemory writingPastEnd inputOutOfBounds
resNotFound resFNotFound addResFailed addRefFailed rmvResFailed
rmvRefFailed resAttrErr mapReadErr CantDecompress badExtResource
noMemForPictPlaybackErr rgnOverflowErr rgnTooBigError pixMapTooDeepErr insufficientStackErr
cMatchErr cTempMemErr cNoMemErr cRangeErr cProtectErr
cDevErr cResErr cDepthErr rgnTooBigErr updPixMemErr
pictInfoVersionErr pictInfoIDErr pictInfoVerbErr cantLoadPickMethodErr colorsRequestedErr
cmProfileError cmMethodError cmMethodNotFound cmProfileNotFound cmProfilesIdentical
cmCantConcatenateError cmCantXYZ cmCantDeleteProfile cmUnsupportedDataType noHardware
notEnoughHardware queueFull resProblem badChannel badFormat
notEnoughBufferSpace badFileFormat channelBusy buffersTooSmall channelNotBusy
noMoreRealTime siVBRCompressionNotSupported siNoSoundInHardware siBadSoundInDevice siNoBufferSpecified
siInvalidCompression siHardDriveTooSlow siInvalidSampleRate siInvalidSampleSize siDeviceBusyErr
siBadDeviceName siBadRefNum siInputDeviceErr siUnknownInfoType noSynthFound
synthOpenFailed synthNotReady bufTooSmall voiceNotFound incompatibleVoice
badDictFormat midiNoClientErr midiNoPortErr midiTooManyPortsErr midiTooManyConsErr
midiVConnectErr midiVConnectMade midiVConnectRmvd midiNoConErr midiWriteErr
midiNameLenErr midiDupIDErr siInitSDTblErr siInitVBLQsErr siInitSPTblErr
sdmJTInitErr sdmInitErr sdmSRTInitErr sdmPRAMInitErr smSDMInitErr
smSRTInitErr smPRAMInitErr smPriInitErr smEmptySlot smCRCFail
smFormatErr smRevisionErr smNoDir smDisabledSlot smResrvErr
smUnExBusErr smBLFieldBad smFHBlockRdErr smFHBlkDispErr smDisposePErr
smNoBoardSRsrc smGetPRErr smNoBoardId smInitStatVErr smInitTblVErr
smNoJmpTbl smReservedSlot smBadBoardId smBusErrTO svTempDisable
svDisabled smBadRefId smBadsList smReservedErr smCPUErr
smsPointerNil smNilsBlockErr smSlotOOBErr smSelOOBErr smNewPErr
smBlkMoveErr smCkStatusErr smGetDrvrNamErr smDisDrvrNamErr smNoMoresRsrcs
smsGetDrvrErr smBadsPtrErr smByteLanesErr smOffsetErr smNoGoodOpens
smSRTOvrFlErr notBTree btNoSpace btDupRecErr btRecNotFnd
btKeyLenErr btKeyAttrErr unknownInsertModeErr recordDataTooBigErr fsmFFSNotFoundErr
fsmBusyFFSErr fsmBadFFSNameErr fsmBadFSDLenErr fsmDuplicateFSIDErr fsmBadFSDVersionErr
fsmNoAlternateStackErr editionMgrInitErr badSectionErr notRegisteredSectionErr badEditionFileErr
badSubPartErr multiplePublisherWrn containerNotFoundWrn containerAlreadyOpenWrn teScrapSizeErr
hwParamErr procNotFound memFragErr appModeErr protocolErr
hardwareConfigErr appMemFullErr appIsDaemon bufferIsSmall noOutstandingHLE
connectionInvalid wrongApplicationPlatform appVersionTooOld threadTooManyReqsErr threadNotFoundErr
notEnoughMemoryErr notHeldErr cannotMakeContiguousErr notLockedErr interruptsMaskedErr
cannotDeferErr vmMorePhysicalThanVirtualErr vmKernelMMUInitErr vmOffErr vmMemLckdErr
vmBadDriver vmInvalidBackingFileIDErr vmMappingPrivilegesErr vmBusyBackingFileErr vmNoMoreBackingFilesErr
vmInvalidFileViewIDErr vmFileViewAccessErr vmNoMoreFileViewsErr vmAddressNotInFileViewErr rcDBNull
rcDBValue rcDBError rcDBBadType rcDBBreak rcDBExec
rcDBBadSessID rcDBBadSessNum rcDBBadDDEV rcDBAsyncNotSupp rcDBBadAsyncPB
rcDBNoHandler rcDBWrongVersion hmHelpDisabled hmBalloonAborted hmSameAsLastBalloon
hmHelpManagerNotInited hmSkippedBalloon hmWrongVersion hmUnknownHelpType hmOperationUnsupported
hmNoBalloonUp notInitErr nameTypeErr noPortErr noGlobalsErr
localOnlyErr destPortErr sessTableErr noSessionErr badReqErr
portNameExistsErr noUserNameErr userRejectErr noMachineNameErr noToolboxNameErr
noResponseErr portClosedErr sessClosedErr badPortNameErr noDefaultUserErr
notLoggedInErr noUserRefErr networkErr noInformErr authFailErr
noUserRecErr badServiceMethodErr badLocNameErr kFMIterationCompleted kFMInvalidFontFamilyErr
kFMInvalidFontErr kFMIterationScopeModifiedErr kFMFontTableAccessErr nbpBuffOvr nbpNoConfirm
nbpConfDiff nbpDuplicate nbpNotFound aspBadVersNum aspBufTooSmall
aspNoMoreSess aspNoServers aspParamErr aspServerBusy aspSessClosed
aspSizeErr aspTooMany reqFailed tooManyReqs tooManySkts
badATPSkt badBuffNum noRelErr cbNotFound noSendResp
noDataArea errRefNum errAborted errState errOpening
errAttention errFwdReset errDSPQueueSize errAECoercionFail errAEDescNotFound
errAECorruptData errAEWrongDataType errAENotAEDesc errAEBadListItem errAENewerVersion
errAENotAppleEvent errAEEventNotHandled errAEReplyNotValid errAEUnknownSendMode errAEWaitCanceled
errAETimeout errAENoUserInteraction errAENotASpecialFunction errAEParamMissed errAEUnknownAddressType
errAEHandlerNotFound errAEReplyNotArrived errAEIllegalIndex errAEImpossibleRange errAEWrongNumberArgs
errAEAccessorNotFound errAENoSuchLogical errAEBadTestKey errAENotAnObjSpec errAENoSuchObject
errAENegativeCount errAEEmptyListContainer errAEUnknownObjectType errAERecordingIsAlreadyOn errAEReceiveTerminate
errAEReceiveEscapeCurrent errAEEventFiltered errAEDuplicateHandler errAEStreamBadNesting errAEStreamAlreadyConverted
errAEDescIsNull errAEBuildSyntaxError errOSASystemError errOSAInvalidID errOSABadStorageType
errOSAScriptError errOSABadSelector errOSASourceNotAvailable errOSANoSuchDialect errOSADataFormatObsolete
errOSADataFormatTooNew errOSACorruptData errOSARecordingIsAlreadyOn errOSAComponentMismatch errOffsetInvalid
errOffsetIsOutsideOfView errTopOfDocument errTopOfBody errEndOfDocument badDragRefErr
badDragItemErr badDragFlavorErr duplicateFlavorErr cantGetFlavorErr duplicateHandlerErr
handlerNotFoundErr dragNotAcceptedErr unsupportedForPlatformErr noSuitableDisplaysErr badImageRgnErr
badImageErr couldNotResolveDataRef badImageDescription badPublicMovieAtom cantFindHandler
cantOpenHandler badComponentType noMediaHandler noDataHandler invalidMedia
invalidTrack invalidMovie invalidSampleTable invalidDataRef invalidHandler
invalidDuration invalidTime cantPutPublicMovieAtom badEditList mediaTypesDontMatch
progressProcAborted movieToolboxUninitialized noRecordOfApp wfFileNotFound cantCreateSingleForkFile
invalidEditState nonMatchingEditState staleEditState userDataItemNotFound maxSizeToGrowTooSmall
badTrackIndex trackIDNotFound trackNotInMovie timeNotInTrack timeNotInMedia
badEditIndex internalQuickTimeError cantEnableTrack invalidRect invalidSampleNum
invalidChunkNum invalidSampleDescIndex invalidChunkCache invalidSampleDescription dataNotOpenForRead
dataNotOpenForWrite dataAlreadyOpenForWrite dataAlreadyClosed endOfDataReached dataNoDataRef
noMovieFound invalidDataRefContainer badDataRefIndex noDefaultDataRef couldNotUseAnExistingSample
featureUnsupported noVideoTrackInMovieErr noSoundTrackInMovieErr soundSupportNotAvailableErr unsupportedAuxiliaryImportData
auxiliaryExportDataUnavailable samplesAlreadyInMediaErr noSourceTreeFoundErr sourceNotFoundErr movieTextNotFoundErr
missingRequiredParameterErr invalidSpriteWorldPropertyErr invalidSpritePropertyErr gWorldsNotSameDepthAndSizeErr invalidSpriteIndexErr
invalidImageIndexErr internalComponentErr notImplementedMusicOSErr cantSendToSynthesizerOSErr cantReceiveFromSynthesizerOSErr
illegalVoiceAllocationOSErr illegalPartOSErr illegalChannelOSErr illegalKnobOSErr illegalKnobValueOSErr
illegalInstrumentOSErr illegalControllerOSErr midiManagerAbsentOSErr synthesizerNotRespondingOSErr synthesizerOSErr
illegalNoteChannelOSErr noteChannelNotAllocatedOSErr tunePlayerFullOSErr tuneParseOSErr noExportProcAvailableErr
componentDllLoadErr componentDllEntryNotFoundErr qtmlDllLoadErr qtmlDllEntryNotFoundErr qtmlUninitialized
unsupportedOSErr cannotFindAtomErr notLeafAtomErr atomsNotOfSameTypeErr atomIndexInvalidErr
duplicateAtomTypeAndIDErr invalidAtomErr invalidAtomContainerErr invalidAtomTypeErr cannotBeLeafAtomErr
pathTooLongErr emptyPathErr noPathMappingErr pathNotVerifiedErr unknownFormatErr
wackBadFileErr wackForkNotFoundErr wackBadMetaDataErr qfcbNotFoundErr qfcbNotCreatedErr
AAPNotCreatedErr AAPNotFoundErr ASDBadHeaderErr ASDBadForkErr ASDEntryNotFoundErr
fileOffsetTooBigErr notAllowedToSaveMovieErr qtNetworkAlreadyAllocatedErr urlDataHHTTPProtocolErr urlDataHHTTPNoNetDriverErr
urlDataHHTTPURLErr urlDataHHTTPRedirectErr urlDataHFTPProtocolErr urlDataHFTPShutdownErr urlDataHFTPBadUserErr
urlDataHFTPBadPasswordErr urlDataHFTPServerErr urlDataHFTPDataConnectionErr urlDataHFTPNoDirectoryErr urlDataHFTPQuotaErr
urlDataHFTPPermissionsErr urlDataHFTPFilenameErr urlDataHFTPNoNetDriverErr urlDataHFTPBadNameListErr urlDataHFTPNeedPasswordErr
urlDataHFTPNoPasswordErr urlDataHFTPServerDisconnectedErr urlDataHFTPURLErr notEnoughDataErr qtActionNotHandledErr
qtXMLParseErr digiUnimpErr qtParamErr matrixErr notExactMatrixErr
noMoreKeyColorsErr notExactSizeErr badDepthErr noDMAErr kernelIncompleteErr
kernelCanceledErr kernelOptionsErr kernelPrivilegeErr kernelUnsupportedErr kernelObjectExistsErr
kernelWritePermissionErr kernelReadPermissionErr kernelExecutePermissionErr kernelDeletePermissionErr kernelExecutionLevelErr
kernelAttributeErr kernelAsyncSendLimitErr kernelAsyncReceiveLimitErr kernelTimeoutErr kernelInUseErr
kernelTerminatedErr kernelExceptionErr kernelIDErr kernelAlreadyFreeErr kernelReturnValueErr
tsmComponentNoErr tsmUnsupScriptLanguageErr tsmInputMethodNotFoundErr tsmNotAnAppErr tsmAlreadyRegisteredErr
tsmNeverRegisteredErr tsmInvalidDocIDErr tsmTSMDocBusyErr tsmDocNotActiveErr tsmNoOpenTSErr
tsmCantOpenComponentErr tsmTextServiceNotFoundErr tsmDocumentOpenErr tsmUseInputWindowErr tsmTSHasNoMenuErr
tsmTSNotOpenErr tsmComponentAlreadyOpenErr tsmInputMethodIsOldErr tsmScriptHasNoIMErr tsmUnsupportedTypeErr
tsmUnknownErr tsmInvalidContext tsmNoHandler tsmNoMoreTokens tsmNoStem
nrLockedErr nrNotEnoughMemoryErr nrInvalidNodeErr nrNotFoundErr nrNotCreatedErr
nrNameErr nrNotSlotDeviceErr nrDataTruncatedErr nrPowerErr nrPowerSwitchAbortErr
nrTypeMismatchErr nrNotModifiedErr nrOverrunErr nrResultCodeBase nrPathNotFound
nrPathBufferTooSmall nrInvalidEntryIterationOp nrPropertyAlreadyExists nrIterationDone nrExitedIteratorScope
nrTransactionAborted invalidIconRefErr noSuchIconErr errOSACantCoerce errOSACantAccess
errOSACantAssign errOSAGeneralError errOSADivideByZero errOSANumericOverflow errOSACantLaunch
errOSAAppNotHighLevelEventAware errOSACorruptTerminology errOSAStackOverflow errOSAInternalTableOverflow errOSADataBlockTooLarge
errOSACantGetTerminology errOSATypeError OSAMessageNotUnderstood OSAUndefinedHandler OSAIllegalAccess
OSAIllegalIndex OSAIllegalRange OSAIllegalAssign OSASyntaxError OSASyntaxTypeError
OSATokenTooLong OSAMissingParameter OSAParameterMismatch OSADuplicateParameter OSADuplicateProperty
OSADuplicateHandler OSAUndefinedVariable OSAInconsistentDeclarations errASCantConsiderAndIgnore errASCantCompareMoreThan32k
errASTerminologyNestingTooDeep errASIllegalFormalParameter errASParameterNotForEvent errASNoResultReturned cfragFirstErrCode
cfragContextIDErr cfragConnectionIDErr cfragNoSymbolErr cfragNoSectionErr cfragNoLibraryErr
cfragDupRegistrationErr cfragFragmentFormatErr cfragUnresolvedErr cfragNoPositionErr cfragNoPrivateMemErr
cfragNoClientMemErr cfragNoIDsErr cfragInitOrderErr cfragImportTooOldErr cfragImportTooNewErr
cfragInitLoopErr cfragInitAtBootErr cfragLibConnErr cfragCFMStartupErr cfragCFMInternalErr
cfragFragmentCorruptErr cfragInitFunctionErr cfragNoApplicationErr cfragArchitectureErr cfragFragmentUsageErr
cfragFileSizeErr cfragNotClosureErr cfragNoRegistrationErr cfragContainerIDErr cfragClosureIDErr
cfragAbortClosureErr cfragOutputLengthErr cfragFirstReservedCode cfragReservedCode_3 cfragReservedCode_2
fragContextNotFound fragConnectionIDNotFound fragSymbolNotFound fragSectionNotFound fragLibNotFound
fragDupRegLibName fragFormatUnknown fragHadUnresolveds fragNoMem fragNoAddrSpace
fragNoContextIDs fragObjectInitSeqErr fragImportTooOld fragImportTooNew fragInitLoop
fragInitRtnUsageErr fragLibConnErr fragMgrInitErr fragConstErr fragCorruptErr
fragUserInitProcErr fragAppNotFound fragArchError fragInvalidFragmentUsage invalidComponentID
validInstancesExist componentNotCaptured componentDontRegister unresolvedComponentDLLErr invalidTranslationPathErr
couldNotParseSourceFileErr noTranslationPathErr badTranslationSpecErr buf2SmallErr noMPPErr
ckSumErr extractErr readQErr atpLenErr atpBadRsp
recNotFnd kOTNoError kOTOutOfMemoryErr kOTNotFoundErr kOTDuplicateFoundErr
kOTBadAddressErr kOTBadOptionErr kOTAccessErr kOTBadReferenceErr kOTNoAddressErr
kOTOutStateErr kOTBadSequenceErr kOTSysErrorErr kOTLookErr kOTBadDataErr
kOTBufferOverflowErr kOTFlowErr kOTNoDataErr kOTNoDisconnectErr kOTNoUDErrErr
kOTBadFlagErr kOTNoReleaseErr kOTNotSupportedErr kOTStateChangeErr kOTNoStructureTypeErr
kOTBadNameErr kOTBadQLenErr kOTAddressBusyErr kOTIndOutErr kOTProviderMismatchErr
kOTResQLenErr kOTResAddressErr kOTQFullErr kOTProtocolErr kOTBadSyncErr
kOTCanceledErr kEPERMErr kENOENTErr kENORSRCErr kEINTRErr
kEIOErr kENXIOErr kEBADFErr kEAGAINErr kENOMEMErr
kEACCESErr kEFAULTErr kEBUSYErr kEEXISTErr kENODEVErr
kEINVALErr kENOTTYErr kEPIPEErr kERANGEErr kEWOULDBLOCKErr
kEDEADLKErr kEALREADYErr kENOTSOCKErr kEDESTADDRREQErr kEMSGSIZEErr
kEPROTOTYPEErr kENOPROTOOPTErr kEPROTONOSUPPORTErr kESOCKTNOSUPPORTErr kEOPNOTSUPPErr
kEADDRINUSEErr kEADDRNOTAVAILErr kENETDOWNErr kENETUNREACHErr kENETRESETErr
kECONNABORTEDErr kECONNRESETErr kENOBUFSErr kEISCONNErr kENOTCONNErr
kESHUTDOWNErr kETOOMANYREFSErr kETIMEDOUTErr kECONNREFUSEDErr kEHOSTDOWNErr
kEHOSTUNREACHErr kEPROTOErr kETIMEErr kENOSRErr kEBADMSGErr
kECANCELErr kENOSTRErr kENODATAErr kEINPROGRESSErr kESRCHErr
kENOMSGErr kOTClientNotInittedErr kOTPortHasDiedErr kOTPortWasEjectedErr kOTBadConfigurationErr
kOTConfigurationChangedErr kOTUserRequestedErr firstPickerError invalidPickerType requiredFlagsDontMatch
pickerResourceError cantLoadPicker cantCreatePickerWindow cantLoadPackage pickerCantLive
colorSyncNotInstalled badProfileError kNSL68kContextNotSupported kNSLSchedulerError kNSLBadURLSyntax
kNSLNoCarbonLib kNSLUILibraryNotAvailable kNSLNotImplementedYet kNSLErrNullPtrError kNSLSomePluginsFailedToLoad
kNSLNullNeighborhoodPtr kNSLNoPluginsForSearch kNSLSearchAlreadyInProgress kNSLNoPluginsFound kNSLPluginLoadFailed
kNSLBadProtocolTypeErr kNSLNullListPtr kNSLBadClientInfoPtr kNSLCannotContinueLookup kNSLBufferTooSmallForData
kNSLNoContextAvailable kNSLRequestBufferAlreadyInList kNSLInvalidPluginSpec kNSLNoSupportForService kNSLBadNetConnection
kNSLBadDataTypeErr kNSLBadServiceTypeErr kNSLBadReferenceErr kNSLNoElementsInList kNSLInsufficientOTVer
kNSLInsufficientSysVer kNSLNotInitialized kDTPHoldJobErr kDTPStopQueueErr kDTPTryAgainErr
cmElementTagNotFound cmIndexRangeErr cmCantDeleteElement cmFatalProfileErr cmInvalidProfile
cmInvalidProfileLocation cmCantCopyModifiedV1Profile cmInvalidSearch cmSearchError cmErrIncompatibleProfile
cmInvalidColorSpace cmInvalidSrcMap cmInvalidDstMap cmNoGDevicesError cmInvalidProfileComment
cmRangeOverFlow cmNamedColorNotFound badFolderDescErr duplicateFolderDescErr noMoreFolderDescErr
invalidFolderTypeErr duplicateRoutingErr routingNotFoundErr internalScrapErr duplicateScrapFlavorErr
badScrapRefErr processStateIncorrectErr scrapPromiseNotKeptErr noScrapPromiseKeeperErr nilScrapFlavorDataErr
scrapFlavorFlagsMismatchErr scrapFlavorSizeMismatchErr illegalScrapFlavorFlagsErr illegalScrapFlavorTypeErr illegalScrapFlavorSizeErr
scrapFlavorNotFoundErr afpAccessDenied afpAuthContinue afpBadUAM afpBadVersNum
afpBitmapErr afpCantMove afpDenyConflict afpDirNotEmpty afpDiskFull
afpEofError afpFileBusy afpFlatVol afpItemNotFound afpLockErr
afpMiscErr afpNoMoreLocks afpNoServer afpObjectExists afpObjectNotFound
afpParmErr afpRangeNotLocked afpRangeOverlap afpSessClosed afpUserNotAuth
afpCallNotSupported afpObjectTypeErr afpTooManyFilesOpen afpServerGoingDown afpCantRename
afpDirNotFound afpIconTypeError afpVolLocked afpObjectLocked afpContainsSharedErr
afpIDNotFound afpIDExists afpDiffVolErr afpCatalogChanged afpSameObjectErr
afpBadIDErr afpPwdSameErr afpPwdTooShortErr afpPwdExpiredErr afpInsideSharedErr
afpInsideTrashErr afpPwdNeedsChangeErr afpPwdPolicyErr afpAlreadyLoggedInErr afpBadDirIDType
afpCantMountMoreSrvre afpAlreadyMounted numberFormattingNotANumberErr numberFormattingOverflowInDestinationErr numberFormattingBadNumberFormattingObjectErr
numberFormattingSpuriousCharErr numberFormattingLiteralMissingErr numberFormattingDelimiterMissingErr numberFormattingEmptyFormatErr numberFormattingBadFormatErr
numberFormattingBadOptionsErr numberFormattingBadTokenErr numberFormattingUnOrderedCurrencyRangeErr numberFormattingBadCurrencyPositionErr numberFormattingNotADigitErr
numberFormattingUnOrdredCurrencyRangeErr textParserBadParamErr textParserObjectNotFoundErr textParserBadTokenValueErr textParserBadParserObjectErr
textParserParamErr textParserNoMoreTextErr textParserBadTextLanguageErr textParserBadTextEncodingErr textParserNoSuchTokenFoundErr
errUnknownAttributeTag errMarginWilllNotFit errNotInImagingMode errAlreadyInImagingMode errEngineNotFound
errIteratorReachedEnd errInvalidRange errOffsetNotOnElementBounday errNoHiliteText errEmptyScrap
errReadOnlyText errUnknownElement errNonContiuousAttribute hrHTMLRenderingLibNotInstalledErr hrMiscellaneousExceptionErr
hrUnableToResizeHandleErr errIANoErr errIAUnknownErr errIAAllocationErr errIAParamErr
errIANoMoreItems errIABufferTooSmall errIACanceled errIAInvalidDocument errIATextExtractionErr
qtsBadSelectorErr qtsBadStateErr qtsBadDataErr qtsUnsupportedDataTypeErr qtsUnsupportedRateErr
qtsUnsupportedFeatureErr qtsTooMuchDataErr qtsUnknownValueErr qtsTimeoutErr qtsConnectionFailedErr
gestaltUnknownErr gestaltUndefSelectorErr gestaltDupSelectorErr menuPropertyInvalidErr menuPropertyInvalid
menuPropertyNotFoundErr menuNotFoundErr menuUsesSystemDefErr menuItemNotFoundErr errInvalidWindowPtr
errInvalidWindowRef errUnsupportedWindowAttributesForClass errWindowDoesNotHaveProxy errInvalidWindowProperty errWindowPropertyNotFound
errUnrecognizedWindowClass errCorruptWindowDescription errUserWantsToDragWindow errWindowsAlreadyInitialized errFloatingWindowsNotInitialized
errWindowNotFound errWindowDoesNotFitOnscreen windowAttributeImmutableErr windowAttributesConflictErr windowManagerInternalErr
windowWrongStateErr windowGroupInvalidErr windowAppModalStateAlreadyExistsErr windowNoAppModalStateErr errWindowDoesntSupportFocus
kNavWrongDialogStateErr kNavWrongDialogClassErr kNavInvalidSystemConfigErr kNavCustomControlMessageFailedErr kNavInvalidCustomControlMessageErr
collectionItemLockedErr collectionItemNotFoundErr collectionIndexRangeErr kDMGenErr kDMMirroringOnAlready
kDMWrongNumberOfDisplays kDMMirroringBlocked kDMCantBlock kDMMirroringNotOn kSysSWTooOld
kDMSWNotInitializedErr kDMDriverNotDisplayMgrAwareErr kDMDisplayNotFoundErr kDMNotFoundErr kDMDisplayAlreadyInstalledErr
kDMMainDisplayCannotMoveErr kDMNoDeviceTableclothErr laTooSmallBufferErr laEnvironmentBusyErr laEnvironmentNotFoundErr
laEnvironmentExistErr laInvalidPathErr laNoMoreMorphemeErr laFailAnalysisErr laTextOverFlowErr
laDictionaryNotOpenedErr laDictionaryUnknownErr laDictionaryTooManyErr laPropertyValueErr laPropertyUnknownErr
laPropertyIsReadOnlyErr laPropertyNotFoundErr laPropertyErr kUSBNoErr kUSBNoTran
kUSBNoDelay kUSBNotSent2Err kUSBNotSent1Err kUSBBufUnderRunErr kUSBBufOvrRunErr
kUSBRes2Err kUSBRes1Err kUSBUnderRunErr kUSBOverRunErr kUSBWrongPIDErr
kUSBPIDCheckErr kUSBNotRespondingErr kUSBEndpointStallErr kUSBDataToggleErr kUSBBitstufErr
kUSBCRCErr kUSBQueueFull kUSBNotHandled kUSBUnknownNotification kUSBInternalReserved10
kUSBInternalReserved9 kUSBInternalReserved8 kUSBInternalReserved7 kUSBInternalReserved6 kUSBInternalReserved5
kUSBInternalReserved4 kUSBInternalReserved3 kUSBInternalReserved2 kUSBPortDisabled kUSBQueueAborted
kUSBTimedOut kUSBDeviceDisconnected kUSBDeviceNotSuspended kUSBDeviceSuspended kUSBInvalidBuffer
kUSBDevicePowerProblem kUSBDeviceBusy kUSBUnknownInterfaceErr kUSBPipeStalledError kUSBPipeIdleError
kUSBNoBandwidthError kUSBAbortedError kUSBFlagsError kUSBCompletionError kUSBPBLengthError
kUSBPBVersionError kUSBNotFound kUSBOutOfMemoryErr kUSBDeviceErr kUSBNoDeviceErr
kUSBAlreadyOpenErr kUSBTooManyTransactionsErr kUSBUnknownRequestErr kUSBRqErr kUSBIncorrectTypeErr
kUSBTooManyPipesErr kUSBUnknownPipeErr kUSBUnknownDeviceErr dcmParamErr dcmNotDictionaryErr
dcmBadDictionaryErr dcmPermissionErr dcmDictionaryNotOpenErr dcmDictionaryBusyErr dcmBlockFullErr
dcmNoRecordErr dcmDupRecordErr dcmNecessaryFieldErr dcmBadFieldInfoErr dcmBadFieldTypeErr
dcmNoFieldErr dcmBadKeyErr dcmTooManyKeyErr dcmBadDataSizeErr dcmBadFindMethodErr
dcmBadPropertyErr dcmProtectedErr dcmNoAccessMethodErr dcmBadFeatureErr dcmIterationCompleteErr
kRAInvalidParameter kRAInvalidPort kRAStartupFailed kRAPortSetupFailed kRAOutOfMemory
kRANotSupported kRAMissingResources kRAIncompatiblePrefs kRANotConnected kRAConnectionCanceled
kRAUnknownUser kRAInvalidPassword kRAInternalError kRAInstallationDamaged kRAPortBusy
kRAUnknownPortState kRAInvalidPortState kRAInvalidSerialProtocol kRAUserLoginDisabled kRAUserPwdChangeRequired
kRAUserPwdEntryRequired kRAUserInteractionRequired kRAInitOpenTransportFailed kRARemoteAccessNotReady kRATCPIPInactive
kRATCPIPNotConfigured kRANotPrimaryInterface kRAConfigurationDBInitErr kRAPPPProtocolRejected kRAPPPAuthenticationFailed
kRAPPPNegotiationFailed kRAPPPUserDisconnected kRAPPPPeerDisconnected kRAPeerNotResponding kRAATalkInactive
kRAExtAuthenticationFailed kRANCPRejectedbyPeer kRADuplicateIPAddr kRACallBackFailed kATSUInvalidTextLayoutErr
kATSUInvalidStyleErr kATSUInvalidTextRangeErr kATSUFontsMatched kATSUFontsNotMatched kATSUNoCorrespondingFontErr
kATSUInvalidFontErr kATSUInvalidAttributeValueErr kATSUInvalidAttributeSizeErr kATSUInvalidAttributeTagErr kATSUInvalidCacheErr
kATSUNotSetErr kATSUNoStyleRunsAssignedErr kATSUQuickDrawTextErr kATSULowLevelErr kATSUNoFontCmapAvailableErr
kATSUNoFontScalerAvailableErr kATSUCoordinateOverflowErr kATSULineBreakInWord kATSUBusyObjectErr kATSUInvalidFontFallbacksErr
kTextUnsupportedEncodingErr kTextMalformedInputErr kTextUndefinedElementErr kTECMissingTableErr kTECTableChecksumErr
kTECTableFormatErr kTECCorruptConverterErr kTECNoConversionPathErr kTECBufferBelowMinimumSizeErr kTECArrayFullErr
kTECBadTextRunErr kTECPartialCharErr kTECUnmappableElementErr kTECIncompleteElementErr kTECDirectionErr
kTECGlobalsUnavailableErr kTECItemUnavailableErr kTECUsedFallbacksStatus kTECNeedFlushStatus kTECOutputBufferFullStatus
unicodeChecksumErr unicodeNoTableErr unicodeVariantErr unicodeFallbacksErr unicodePartConvertErr
unicodeBufErr unicodeCharErr unicodeElementErr unicodeNotFoundErr unicodeTableFormatErr
unicodeDirectionErr unicodeContextualErr kUTCUnderflowErr kUTCOverflowErr codecErr
noCodecErr codecUnimpErr codecSizeErr codecScreenBufErr codecImageBufErr
codecSpoolErr codecAbortErr codecWouldOffscreenErr codecBadDataErr codecDataVersErr
codecExtensionNotFoundErr scTypeNotFoundErr codecConditionErr codecOpenErr codecCantWhenErr
codecCantQueueErr codecNothingToBlitErr codecNoMemoryPleaseWaitErr codecDisabledErr codecNeedToFlushChainErr
lockPortBitsBadSurfaceErr lockPortBitsWindowMovedErr lockPortBitsWindowResizedErr lockPortBitsWindowClippedErr lockPortBitsBadPortErr
lockPortBitsSurfaceLostErr codecParameterDialogConfirm codecNeedAccessKeyErr codecOffscreenFailedErr codecDroppedFrameErr
directXObjectAlreadyExists lockPortBitsWrongGDeviceErr kBadAdapterErr kBadAttributeErr kBadBaseErr
kBadEDCErr kBadIRQErr kBadOffsetErr kBadPageErr kBadSizeErr
kBadSocketErr kBadTypeErr kBadVccErr kBadVppErr kBadWindowErr
kBadArgLengthErr kBadArgsErr kBadHandleErr kBadCISErr kBadSpeedErr
kReadFailureErr kWriteFailureErr kGeneralFailureErr kNoCardErr kUnsupportedFunctionErr
kUnsupportedModeErr kBusyErr kWriteProtectedErr kConfigurationLockedErr kInUseErr
kNoMoreItemsErr kOutOfResourceErr kNoCardSevicesSocketsErr kInvalidRegEntryErr kBadLinkErr
kBadDeviceErr k16BitCardErr kCardBusCardErr kPassCallToChainErr kCantConfigureCardErr
kPostCardEventErr kInvalidDeviceNumber kUnsupportedVsErr kInvalidCSClientErr kBadTupleDataErr
kBadCustomIFIDErr kNoIOWindowRequestedErr kNoMoreTimerClientsErr kNoMoreInterruptSlotsErr kNoClientTableErr
kUnsupportedCardErr kNoCardEnablersFoundErr kNoEnablerForCardErr kNoCompatibleNameErr kClientRequestDenied
kNotReadyErr kTooManyIOWindowsErr kAlreadySavedStateErr kAttemptDupCardEntryErr kCardPowerOffErr
kNotZVCapableErr noDeviceForChannel grabTimeComplete cantDoThatInCurrentMode notEnoughMemoryToGrab
notEnoughDiskSpaceToGrab couldntGetRequiredComponent badSGChannel seqGrabInfoNotAvailable deviceCantMeetRequest
badControllerHeight editingNotAllowed controllerBoundsNotExact cannotSetWidthOfAttachedController controllerHasFixedHeight
errAEBadKeyForm errAECantHandleClass errAECantSupplyType errAECantUndo errAEEventFailed
errAEIndexTooLarge errAEInTransaction errAELocalOnly errAENoSuchTransaction errAENotAnElement
errAENotASingleObject errAENotModifiable errAENoUserSelection errAEPrivilegeError errAEReadDenied
errAETypeError errAEWriteDenied errAENotAnEnumMember errAECantPutThatThere telGenericError
telNoErr telNoTools telBadTermErr telBadDNErr telBadCAErr
telBadHandErr telBadProcErr telCAUnavail telNoMemErr telNoOpenErr
telBadHTypeErr telHTypeNotSupp telBadLevelErr telBadVTypeErr telVTypeNotSupp
telBadAPattErr telAPattNotSupp telBadIndex telIndexNotSupp telBadStateErr
telStateNotSupp telBadIntExt telIntExtNotSupp telBadDNDType telDNDTypeNotSupp
telFeatNotSub telFeatNotAvail telFeatActive telFeatNotSupp telConfLimitErr
telConfNoLimit telConfErr telConfRej telTransferErr telTransferRej
telCBErr telConfLimitExceeded telBadDNType telBadPageID telBadIntercomID
telBadFeatureID telBadFwdType telBadPickupGroupID telBadParkID telBadSelect
telBadBearerType telBadRate telDNTypeNotSupp telFwdTypeNotSupp telBadDisplayMode
telDisplayModeNotSupp telNoCallbackRef telAlreadyOpen telStillNeeded telTermNotOpen
telCANotAcceptable telCANotRejectable telCANotDeflectable telPBErr telBadFunction
telNoSuchTool telUnknownErr telNoCommFolder telInitFailed telBadCodeResource
telDeviceNotFound telBadProcID telValidateFailed telAutoAnsNotOn telDetAlreadyOn
telBadSWErr telBadSampleRate pmBusyErr pmReplyTOErr pmSendStartErr
pmSendEndErr pmRecvStartErr kPowerHandlerExistsForDeviceErr kPowerHandlerNotFoundForDeviceErr kPowerHandlerNotFoundForProcErr
kPowerMgtMessageNotHandled kPowerMgtRequestDenied kCantReportProcessorTemperatureErr kProcessorTempRoutineRequiresMPLib2 kNoSuchPowerSource
debuggingExecutionContextErr debuggingDuplicateSignatureErr debuggingDuplicateOptionErr debuggingInvalidSignatureErr debuggingInvalidOptionErr
debuggingInvalidNameErr debuggingNoCallbackErr kHIDVersionIncompatibleErr kHIDSuccess kHIDInvalidRangePageErr
kHIDReportIDZeroErr kHIDReportCountZeroErr kHIDReportSizeZeroErr kHIDUnmatchedDesignatorRangeErr kHIDUnmatchedStringRangeErr
kHIDInvertedUsageRangeErr kHIDUnmatchedUsageRangeErr kHIDInvertedPhysicalRangeErr kHIDInvertedLogicalRangeErr kHIDBadLogicalMaximumErr
kHIDBadLogicalMinimumErr kHIDUsagePageZeroErr kHIDEndOfDescriptorErr kHIDNotEnoughMemoryErr kHIDBadParameterErr
kHIDNullPointerErr kHIDInvalidReportLengthErr kHIDInvalidReportTypeErr kHIDBadLogPhysValuesErr kHIDIncompatibleReportErr
kHIDInvalidPreparsedDataErr kHIDNotValueArrayErr kHIDUsageNotFoundErr kHIDValueOutOfRangeErr kHIDBufferTooSmallErr
kHIDNullStateErr kModemOutOfMemory kModemPreferencesMissing kTXNEndIterationErr kTXNCannotAddFrameErr
kTXNInvalidFrameIDErr kTXNIllegalToCrossDataBoundariesErr kTXNUserCanceledOperationErr kTXNBadDefaultFileTypeWarning kTXNCannotSetAutoIndentErr
kTXNRunIndexOutofBoundsErr kTXNNoMatchErr kTXNAttributeTagInvalidForRunErr kTXNSomeOrAllTagsInvalidForRunErr kTXNInvalidRunIndex
kTXNAlreadyInitializedErr kTXNCannotTurnTSMOffWhenUsingUnicodeErr kTXNCopyNotAllowedInEchoModeErr kTXNDataTypeNotAllowedErr kTXNATSUIIsNotInstalledErr
kTXNOutsideOfLineErr errKCNotAvailable errKCReadOnly errKCAuthFailed errKCNoSuchKeychain
errKCInvalidKeychain errKCDuplicateKeychain errKCDuplicateCallback errKCInvalidCallback errKCDuplicateItem
errKCItemNotFound errKCBufferTooSmall errKCDataTooLarge errKCNoSuchAttr errKCInvalidItemRef
errKCInvalidSearchRef errKCNoSuchClass errKCNoDefaultKeychain errKCInteractionNotAllowed errKCReadOnlyAttr
errKCWrongKCVersion errKCKeySizeNotAllowed errKCNoStorageModule errKCNoCertificateModule errKCNoPolicyModule
errKCInteractionRequired errKCDataNotAvailable errKCDataNotModifiable kUCOutputBufferTooSmall kUCTSNoKeysAddedToObjectErr
kMPIterationEndErr kMPPrivilegedErr kMPProcessCreatedErr kMPProcessTerminatedErr kMPTaskCreatedErr
kMPTaskBlockedErr kMPTaskStoppedErr kMPBlueBlockingErr kMPDeletedErr kMPTimeoutErr
kMPTaskAbortedErr kMPInsufficientResourcesErr kCollateAttributesNotFoundErr kCollateInvalidOptions kCollateMissingUnicodeTableErr
kCollateUnicodeConvertFailedErr kCollatePatternNotFoundErr kCollateInvalidChar kCollateBufferTooSmall kFNSInvalidReferenceErr
kFNSBadReferenceVersionErr kFNSInvalidProfileErr kFNSBadProfileVersionErr kFNSDuplicateReferenceErr kFNSMismatchErr
kFNSInsufficientDataErr kFNSBadFlattenedSizeErr kLocalesBufferTooSmallErr kLocalesTableFormatErr kALMInternalErr
kALMGroupNotFoundErr kALMNoSuchModuleErr kALMModuleCommunicationErr kALMDuplicateModuleErr kALMInstallationErr
kALMDeferSwitchErr kSSpInternalErr kSSpVersionErr kSSpCantInstallErr kSSpParallelUpVectorErr
kNSpInitializationFailedErr kNSpAlreadyInitializedErr kNSpTopologyNotSupportedErr kNSpPipeFullErr kNSpHostFailedErr
kNSpProtocolNotAvailableErr kNSpInvalidGameRefErr kNSpInvalidParameterErr kNSpOTNotPresentErr kNSpOTVersionTooOldErr
kNSpMemAllocationErr kNSpAlreadyAdvertisingErr kNSpNotAdvertisingErr kNSpInvalidAddressErr kNSpFreeQExhaustedErr
kNSpRemovePlayerFailedErr kNSpAddressInUseErr kNSpFeatureNotImplementedErr kNSpNameRequiredErr kNSpInvalidPlayerIDErr
kNSpInvalidGroupIDErr kNSpNoPlayersErr kNSpNoGroupsErr kNSpNoHostVolunteersErr kNSpCreateGroupFailedErr
kNSpAddPlayerFailedErr kNSpInvalidDefinitionErr kNSpInvalidProtocolRefErr kNSpInvalidProtocolListErr kNSpTimeoutErr
kNSpGameTerminatedErr kNSpConnectFailedErr kNSpSendFailedErr kNSpMessageTooBigErr kNSpCantBlockErr
kISpInternalErr kISpSystemListErr kISpBufferToSmallErr kISpElementInListErr kISpElementNotInListErr
kISpSystemInactiveErr kISpDeviceInactiveErr kISpSystemActiveErr kISpDeviceActiveErr kDSpNotInitializedErr
kDSpSystemSWTooOldErr kDSpInvalidContextErr kDSpInvalidAttributesErr kDSpContextAlreadyReservedErr kDSpContextNotReservedErr
kDSpContextNotFoundErr kDSpFrameRateNotReadyErr kDSpConfirmSwitchWarning kDSpInternalErr kFBCvTwinExceptionErr
kFBCnoIndexesFound kFBCallocFailed kFBCbadParam kFBCfileNotIndexed kFBCbadIndexFile
kFBCcompactionFailed kFBCvalidationFailed kFBCindexingFailed kFBCcommitFailed kFBCdeletionFailed
kFBCmoveFailed kFBCtokenizationFailed kFBCmergingFailed kFBCindexCreationFailed kFBCaccessorStoreFailed
kFBCaddDocFailed kFBCflushFailed kFBCindexNotFound kFBCnoSearchSession kFBCindexingCanceled
kFBCaccessCanceled kFBCindexFileDestroyed kFBCindexNotAvailable kFBCsearchFailed kFBCsomeFilesNotIndexed
kFBCillegalSessionChange kFBCanalysisNotAvailable kFBCbadIndexFileVersion kFBCsummarizationCanceled kFBCindexDiskIOFailed
kFBCbadSearchSession notAQTVRMovieErr constraintReachedErr callNotSupportedByNodeErr selectorNotSupportedByNodeErr
invalidNodeIDErr invalidViewStateErr timeNotInViewErr propertyNotSupportedByNodeErr settingNotSupportedByNodeErr
limitReachedErr invalidNodeFormatErr invalidHotSpotIDErr noMemoryNodeFailedInitialize streamingNodeNotReadyErr
qtvrLibraryLoadErr themeInvalidBrushErr themeProcessRegisteredErr themeProcessNotRegisteredErr themeBadTextColorErr
themeHasNoAccentsErr themeBadCursorIndexErr themeScriptFontNotFoundErr errMessageNotSupported errDataNotSupported
errControlDoesntSupportFocus errUnknownControl errCouldntSetFocus errNoRootControl errRootAlreadyExists
errInvalidPartCode errControlsAlreadyExist errControlIsNotEmbedder errDataSizeMismatch errControlHiddenOrDisabled
errCantEmbedIntoSelf errCantEmbedRoot errItemNotControl controlInvalidDataVersionErr controlPropertyInvalid
controlPropertyNotFoundErr kURLInvalidURLReferenceError kURLProgressAlreadyDisplayedError kURLDestinationExistsError kURLInvalidURLError
kURLUnsupportedSchemeError kURLServerBusyError kURLAuthenticationError kURLPropertyNotYetKnownError kURLUnknownPropertyError
kURLPropertyBufferTooSmallError kURLUnsettablePropertyError kURLInvalidCallError kURLFileEmptyError kURLExtensionFailureError
kURLInvalidConfigurationError kURLAccessNotAvailableError badComponentInstance dsBusError dsAddressErr
dsIllInstErr dsZeroDivErr dsChkErr dsOvflowErr dsPrivErr
dsTraceErr dsLineAErr dsLineFErr dsMiscErr dsCoreErr
dsIrqErr dsIOCoreErr dsLoadErr dsFPErr dsNoPackErr
dsNoPk1 dsNoPk3 dsNoPk4 dsNoPk5 dsNoPk6
dsNoPk7 dsMemFullErr dsBadLaunch dsFSErr dsStknHeap
negZcbFreeErr dsFinderErr dsBadSlotInt dsBadSANEOpcode dsBadPatchHeader
menuPrgErr dsMBarNFnd dsHMenuFindErr dsWDEFNotFound dsCDEFNotFound
dsNoFPU dsNoPatch dsBadPatch dsParityErr dsOldSystem
ds32BitMode dsNeedToWriteBootBlocks dsNotEnoughRAMToBoot dsBufPtrTooLow dsVMDeferredFuncTableFull
dsVMBadBackingStore dsCantHoldSystemHeap dsSystemRequiresPowerPC dsGibblyMovedToDisabledFolder dsUnBootableSystem
dsMustUseFCBAccessors dsMacOSROMVersionTooOld dsLostConnectionToNetworkDisk dsRAMDiskTooBig dsWriteToSupervisorStackGuardPage
dsReinsert shutDownAlert dsShutDownOrRestart dsSwitchOffOrRestart dsForcedQuit
dsRemoveDisk dsDirtyDisk dsShutDownOrResume dsSCSIWarn dsMBSysError
dsMBFlpySysError dsMBATASysError dsMBATAPISysError dsMBExternFlpySysError dsNoExtsMacsBug
dsNoExtsDisassembler dsMacsBugInstalled dsDisassemblerInstalled dsExtensionsDisabled dsGreeting
dsSysErr CDEFNFnd dsNotThe1 dsBadStartupDisk dsSystemFileErr
dsHD20Installed mBarNFnd fsDSIntErr hMenuFindErr userBreak
strUserBreak dsBadLibrary
);
