...
/* ComponentError codes*/
  badComponentInstance          = 0x80008001, /* when cast to an OSErr this is -32767*/
  badComponentSelector          = 0x80008002 /* when cast to an OSErr this is -32766*/
};
